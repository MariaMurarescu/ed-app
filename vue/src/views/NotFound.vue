<template>
    <div class="flex justify-center items-center min-h-full w-full min-w-full">
      <div class="flex">
        ...
        <div class="px-8">
          <h1 class="text-5xl font-bold mb-2">Pagina nu a fost găsită!</h1>
          <p class="text-gray-400  mb-10">Verificați adresa URL și încercați din nou!</p>
          <div>
            <router-link :to="{name: 'DeVorba'}"
